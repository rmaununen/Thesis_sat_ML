...
x_test_rows = []
y_test_rows = []
with open("Testing_with_30_point_arrays/3test_0.txt", "r") as f:
    for line in f:
...
tf_model_name = 'ptm_1'  #The existing model
tflite_model_name = 'ptm_1_1'  # Will be given .tflite suffix
c_model_name = 'ptm_1_1'       # Will be given .h suffix
