...
#REPORT PARAMETERS
id = 1.6 #test ID that will be printed in the report name header
...
threshold_out = 0.15
model_name = f'adm_14.h  (WITH THRESHOLD OUTPUT CLASSIFICATION {threshold_out}) same as adm_13 but trained not to follow anomalies'
tf_model_name = 'adm_14'  #The existing model
...
date_time = '10.05.2023'#formatted_date_time #Change this if you want the time to be something else