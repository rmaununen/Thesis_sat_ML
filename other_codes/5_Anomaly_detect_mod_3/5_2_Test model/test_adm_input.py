...
#REPORT PARAMETERS
id = '3.11.4' #test ID that will be printed in the report name header
n_test_sets = 32
...
tflite_model_name = tf_model_name+'_n'  # Will be given .tflite suffix
c_model_name = tf_model_name+'_n'       # Will be given .h suffix
model_type = 'MLP'
...
nsamples = 82   # Number of samples to use as a representative dataset (<len(rep_dataset))
