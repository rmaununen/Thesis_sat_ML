...
sys.path.append('/Users/rmc0mputer/PycharmProjects/Thesis_sat_ML/other_codes/5_Anomaly_detect_mod_3/5_0_Produce_dataset')
#from dataset_functions import *

Dataset_dir = '/Users/rmc0mputer/PycharmProjects/Thesis_sat_ML/other_codes/5_Anomaly_detect_mod_3/Dataset'
Working_dir = '/Users/rmc0mputer/PycharmProjects/Thesis_sat_ML/other_codes/5_Anomaly_detect_mod_3/5_1_Train model'

training_dataset = 'training_dataset_3_0_3.txt'
...
# Settings
#plot_ds = True
nsamples = 26499#10718     # Number of samples to use as a dataset
val_ratio = 0.3     # Fraction of samples that should be held for validation set
model_name = 'adm_3_10_2'  # Will be given .h5 suffix
N_i = 17 # number of input neurons
H1 = 96 # number of neurons on the hidden layers
H2 = 96 # number of neurons on the hidden layers
H3 = 96 # number of neurons on the hidden layers
H4 = 96 # number of neurons on the hidden layers
N_o = 4 # number of output neurons
nepochs = 400
sbatch = 75
...
model = tf.keras.Sequential([
    ...
    #tf.keras.layers.Dense(H4, activation='relu'),
...
# Compile the model
model.compile(optimizer=tf.keras.optimizers.Adam(lr=0.01), loss='msle', metrics=['msle'])
